...
public class IsBooleanConditionExpressionTest {
    ...
    public void testIsExpressionType() {
        ...
        assertTrue(expression instanceof io.github.anthem37.sql.rewiter.core.extension.expression.IConditionExpression);
    }
    ...
    public void testReconstructAliasExpressionReturnsCorrectType() {
        ...
        // 验证返回类型正确
        io.github.anthem37.sql.rewiter.core.extension.expression.IConditionExpression result = original.reconstructAliasExpression("u");
